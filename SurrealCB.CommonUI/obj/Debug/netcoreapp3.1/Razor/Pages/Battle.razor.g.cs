#pragma checksum "C:\Rikito\SurrealCB\SurrealCB.CommonUI\Pages\Battle.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "f9d506485d58cda27182c0b5513efd431a99ee2e"
// <auto-generated/>
...
#line 18 "C:\Rikito\SurrealCB\SurrealCB.CommonUI\Pages\Battle.razor"
    ...
    private async Task CheckNext()
    {
        ...
        if (this.nextPosition > 3)
        {
            ...
            var newStatus = Newtonsoft.Json.JsonConvert.DeserializeObject<BattleStatus>(nextResponse.Result.ToString());
    ...
    private async Task PlayerPerform(int pos)
    {
        if (this.nextPosition < 4)
        {
            ...
            this.cards = Newtonsoft.Json.JsonConvert.DeserializeObject<BattleCard[]>(atkResponse.Result.ToString()).ToList<BattleCard>();
            await this.CheckNext();
        }
    }
